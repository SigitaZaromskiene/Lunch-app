      ...
      {meals.map((meal: MealProps) => (
        <li key={meal.id} className={cx("menu-list")}>
          <div className="menu-list-header">
            <div className="menu-list-header__image">
              {selectMenuImg(meal.title)}
            </div>
            <div className="menu-list-header__img-container"></div>
            <h1 className="menu-list-header__text">
              {meal.title}
              <div className="menu-list-header__text-icon">
                {meal.vegetarian && (
